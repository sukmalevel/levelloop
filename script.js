...
window.addEventListener('load', async () => {
  try {
    // Pastikan FFmpeg dari window
    if (typeof createFFmpeg === 'undefined') {
      alert('FFmpeg gagal dimuat. Cek koneksi atau muat ulang.');
    ...
    // Setelah FFmpeg siap, inisialisasi DOM
    initApp();
  } catch (err) {
    console.error('Gagal inisialisasi FFmpeg:', err);
    alert('Gagal muat FFmpeg. Coba lagi nanti.');
  }
});
